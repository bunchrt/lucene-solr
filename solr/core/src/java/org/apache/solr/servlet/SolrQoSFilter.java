  ...
  protected int getPriority(ServletRequest request) {
   ...
   // boolean internal = Boolean.parseBoolean((String) request.getServletContext().getAttribute("internal"));
    ...
    if (!externalRequest) {
      ...
      if (pathInfo != null && pathInfo.contains("/get") || pathInfo.contains("/replicate")) {
        return 10;
      } if (pathInfo != null && pathInfo.contains("/cores")) {
        return 9;
      } else if (pathInfo != null && pathInfo.equals("/admin/collections")) {
        return 8;
