...
//    }
  ...
  CreatePath createRequestNode(byte[] data) throws KeeperException, InterruptedException {
    ...
    createPath.path = zookeeper.create(dir + "/" + PREFIX, data, CreateMode.EPHEMERAL_SEQUENTIAL, true);

//    zookeeper.create(dir + "/" + PREFIX, data, CreateMode.EPHEMERAL_SEQUENTIAL, (rc2, path2, ctx, name, stat2) -> {
//      try {
//        if (rc2 != 0) {
